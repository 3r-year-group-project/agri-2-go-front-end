...
export default function GrocerySellerRegistrationForm() {
    ...
    const handleSubmitComponent1 = (ob) => {
        ...
        axios.post('/api/groceryseller/registration/paymentPlan',ob).then(res => {
            if(res){
                setStepState((prev) => {
                    return [
                        true,
   ...
   const handleSubmitComponent2 = (ob) => {
    ...
    const handleSubmitComponent3 = (ob) => {
        axios.post('/api/groceryseller/registration/personDetails',ob).then((res)=>{
            setStepState((prev) => {
                return [
                   prev[0],
                   prev[1],
    ...
    const handleSubmitComponent4 = (ob) => {
        axios.post('/api/groceryseller/registration/shopdetails',ob).then((res)=>{
            setStepState((prev) => {
                return [
                   prev[0],
                   prev[1],
