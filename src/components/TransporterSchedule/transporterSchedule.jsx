...
export default function TransportationSchedule(props) {
  ...
  return (
    ...
    <Dialog open={openConfirm} onClose={handleConfirmClose}>
        <DialogTitle style={{backgroundColor: 'white', color: 'black'}}>Start Journery</DialogTitle>
      ...
      autoComplete="off"
    >
      <TextField id="journey-code" label="Journery Code" variant="filled" />
    </Box>
          </DialogContentText>
          </DialogContent>
        <DialogActions style={{backgroundColor: 'white'}}>
          <Button variant="contained" color="error" onClick={handleConfirmClose}>Cancel</Button>
          <Button onClick={handleConfirmClose} variant="outlined" color="secondary">Start The journey</Button>
        </DialogActions>
      </Dialog>
