...
export default function TransporterTable() {
  ...
  React.useEffect(() => {
    axios
      .get("api/admin/get/transporter/revenue")
      .then((res) => {
        console.log("transport revenue",res.data);
  ...
  const [tranportRequestId, setTransportRequestId] = React.useState("");

  const handleClickOpen = (s) => {
    setOpen(true);
    setTransportRequestId(s);
  };


  const handleApprove = () => {
    axios
      .put('api/admin/release/transporter/fund/'+tranportRequestId)
      .then((res) => {
                                ...
                                <TableCell align="left">
                                  ...
                                  >
                                    ...
                                    <DialogActions>
                                      ...
                                      <Button
                                        variant="contained"
                                        onClick={()=>{handleClose();handleApprove();}}
                                        autoFocus
                                      >
                                        Yes
                                      </Button>
